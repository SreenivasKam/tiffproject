...
void makerle3(){
    ...
    int temp =-1,ones=1;
    ftr = fopen("D:/FINAL YEAR PROJECT/sample_bin_uc10.txt","rb");
    txt = fopen("D:/FINAL YEAR PROJECT/work/rled2.txt","wb");
    if(ftr == NULL){
        printf("Error in opening the file");
    }
    else{
...
void byteboundaryfixing()
{
    ...
    int sum=0,p=0,n=0;
    ftr = fopen("D:/FINAL YEAR PROJECT/work/rled2.txt","rb");
    txt = fopen("D:/FINAL YEAR PROJECT/work/edittedcode.txt","wb");
    if(ftr == NULL){
        printf("Error in opening the file");
    }
    else
