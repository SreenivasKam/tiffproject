...
void maketiff(){
    ...
    txt=fopen("D:/FINAL YEAR PROJECT/maketiffer-remadesam.tiff","wb");
    ...
    ptr=fopen("D:/FINAL YEAR PROJECT/work/edittedcode-1d-3.txt","rb");
    ...
    if (txt == NULL) {
        ...
        fputc(value2,txt);
        //tags
        struct DIR_header tags[15] ={ {254,4,1,2},{255,3,1,3},{256,3,1,1728},{257,3,1,3203},
        {258,3,1,1},{259,3,1,3},{262,3,1,0},{273,4,1,240},{278,3,1,3203},{279,4,1,2661349},
